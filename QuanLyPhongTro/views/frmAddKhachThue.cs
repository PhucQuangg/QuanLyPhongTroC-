...
namespace QuanLyPhongTro.views
{
    public partial class frmAddKhachThue : Form
    {
        ...
        public frmAddKhachThue()
        {
            ...
            dtpNgayThue.Value = dtpNgayThue.Value = DateTime.Today;
            dtpNgayKetThuc.Value = dtpNgayKetThuc.Value = DateTime.Today;
            dtpNgaySinh.Value = dtpNgaySinh.Value = DateTime.Today;
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (txtMaKhachHang.Text != "" && txtHoTen.Text != "" & txtQueQuan.Text != "" & txtSdt.Text != "")
            {
                try
                {
                    ...
                    MessageBox.Show(@"Thêm khách thuê thành công", @"Notice");
                    this.Close();
                }
                catch
                {
